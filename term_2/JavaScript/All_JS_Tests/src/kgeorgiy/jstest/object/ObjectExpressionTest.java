package kgeorgiy.jstest.object;

import kgeorgiy.expression.BaseTest;
import kgeorgiy.jstest.*;

import java.util.List;
import java.util.function.BiFunction;

import static kgeorgiy.jstest.functional.FunctionalExpressionTest.POLISH;
...
//        System.out.format("new int[]{%s}%n", Arrays.stream(actual).mapToObj(Integer::toString).collect(Collectors.joining(", ")));
    ...
    public static <T extends BaseTest> void test(final Class<T> type, final BiFunction<Integer, Language, T> cons, final AbstractTests tests, final String[] args, final BaseJavascriptTest.Dialect parsed) {
