package kgeorgiy.cljtest.functional;

import kgeorgiy.cljtest.ClojureEngine;
import kgeorgiy.cljtest.multi.MultiTests;
import kgeorgiy.jstest.AbstractTests;
import kgeorgiy.jstest.BaseJavascriptTest;
...
public class ClojureFunctionalExpressionTest extends BaseJavascriptTest<ClojureEngine> {
    public static final BaseJavascriptTest.Dialect PARSED = dialect(
            "(variable \"%s\")",
            "(constant %s.0)",
