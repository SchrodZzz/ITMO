    ...
    public static void main(String[] args) throws IOException {
        ...
        try (FastScanner reader = new FastScanner
            ...
            while (reader.hasNext()) {
                ...
                lineCounter++;
                for (String currentWord : reader.getLine().toLowerCase().split("[^\\p{L}\\p{Pd}']")) {
            ...
            try (BufferedWriter writer = new BufferedWriter(
                ...
                for (Map.Entry <String, ArrayList <AdditionalPair <Integer, Integer>>> currentWordStatisticPair
                    ...
                    for (AdditionalPair <Integer, Integer> currentWordStatistic : currentWordStatisticPair.getValue()) {
