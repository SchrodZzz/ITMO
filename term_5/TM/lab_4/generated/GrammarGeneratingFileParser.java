...
public class GrammarGeneratingFileParser extends Parser {
	...
	public GrammarGeneratingFileParser(TokenStream input) {
		super(input);
	...
	public static class RootContext extends ParserRuleContext {
		...
		public TerminalNode GRAMMAR_NAME() { return getToken(GrammarGeneratingFileParser.GRAMMAR_NAME, 0); }
		public TerminalNode LEXEM() { return getToken(GrammarGeneratingFileParser.LEXEM, 0); }
		public TerminalNode IDENTIFIER() { return getToken(GrammarGeneratingFileParser.IDENTIFIER, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarGeneratingFileListener ) ((GrammarGeneratingFileListener)listener).enterRoot(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarGeneratingFileListener ) ((GrammarGeneratingFileListener)listener).exitRoot(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GrammarGeneratingFileVisitor ) return ((GrammarGeneratingFileVisitor<? extends T>)visitor).visitRoot(this);
	...
	public static class HeaderContext extends ParserRuleContext {
		public String code;
		public Token CODE;
		public TerminalNode CODE() { return getToken(GrammarGeneratingFileParser.CODE, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarGeneratingFileListener ) ((GrammarGeneratingFileListener)listener).enterHeader(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarGeneratingFileListener ) ((GrammarGeneratingFileListener)listener).exitHeader(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GrammarGeneratingFileVisitor ) return ((GrammarGeneratingFileVisitor<? extends T>)visitor).visitHeader(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Rule_Context extends ParserRuleContext {
		...
		public TerminalNode LEXEM() { return getToken(GrammarGeneratingFileParser.LEXEM, 0); }
		public List<TerminalNode> STRING() { return getTokens(GrammarGeneratingFileParser.STRING); }
		public TerminalNode STRING(int i) {
			return getToken(GrammarGeneratingFileParser.STRING, i);
		}
		public TerminalNode SKIPP() { return getToken(GrammarGeneratingFileParser.SKIPP, 0); }
		public TerminalNode IDENTIFIER() { return getToken(GrammarGeneratingFileParser.IDENTIFIER, 0); }
		...
		public List<TerminalNode> PARAM() { return getTokens(GrammarGeneratingFileParser.PARAM); }
		public TerminalNode PARAM(int i) {
			return getToken(GrammarGeneratingFileParser.PARAM, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarGeneratingFileListener ) ((GrammarGeneratingFileListener)listener).enterRule_(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarGeneratingFileListener ) ((GrammarGeneratingFileListener)listener).exitRule_(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GrammarGeneratingFileVisitor ) return ((GrammarGeneratingFileVisitor<? extends T>)visitor).visitRule_(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class VariantContext extends ParserRuleContext {
		...
		public Token name;
		public Token PARAM;
		public TerminalNode EMPTY() { return getToken(GrammarGeneratingFileParser.EMPTY, 0); }
		public List<TerminalNode> CODE() { return getTokens(GrammarGeneratingFileParser.CODE); }
		public TerminalNode CODE(int i) {
			return getToken(GrammarGeneratingFileParser.CODE, i);
		}
		public List<TerminalNode> IDENTIFIER() { return getTokens(GrammarGeneratingFileParser.IDENTIFIER); }
		public TerminalNode IDENTIFIER(int i) {
			return getToken(GrammarGeneratingFileParser.IDENTIFIER, i);
		}
		public List<TerminalNode> LEXEM() { return getTokens(GrammarGeneratingFileParser.LEXEM); }
		public TerminalNode LEXEM(int i) {
			return getToken(GrammarGeneratingFileParser.LEXEM, i);
		}
		public List<TerminalNode> PARAM() { return getTokens(GrammarGeneratingFileParser.PARAM); }
		public TerminalNode PARAM(int i) {
			return getToken(GrammarGeneratingFileParser.PARAM, i);
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarGeneratingFileListener ) ((GrammarGeneratingFileListener)listener).enterVariant(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarGeneratingFileListener ) ((GrammarGeneratingFileListener)listener).exitVariant(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GrammarGeneratingFileVisitor ) return ((GrammarGeneratingFileVisitor<? extends T>)visitor).visitVariant(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\7\4\2\2\35\36\7\f\2\2\36\37\b\3\1\2\37\5\3\2\2\2 !\7\17\2\2!\"\b\4\1"+
		"\2\"\61\7\5\2\2#$\7\13\2\2$%\7\n\2\2%\62\b\4\1\2&\'\7\13\2\2\'(\b\4\1"+
		"\2(.\3\2\2\2)*\7\6\2\2*+\7\13\2\2+-\b\4\1\2,)\3\2\2\2-\60\3\2\2\2.,\3"+
		"\2\2\2./\3\2\2\2/\62\3\2\2\2\60.\3\2\2\2\61#\3\2\2\2\61&\3\2\2\2\62K\3"+
		"\2\2\2\63\64\7\16\2\2\64\67\b\4\1\2\65\66\7\r\2\2\668\b\4\1\2\67\65\3"+
		"\2\2\2\678\3\2\2\28<\3\2\2\29:\7\7\2\2:;\7\r\2\2;=\b\4\1\2<9\3\2\2\2<"+
		...
		"IG\3\2\2\2J \3\2\2\2J\63\3\2\2\2K\7\3\2\2\2LN\7\t\2\2MO\7\f\2\2NM\3\2"+
		"\2\2NO\3\2\2\2OP\3\2\2\2Pa\b\5\1\2QS\7\16\2\2RT\7\r\2\2SR\3\2\2\2ST\3"+
		"\2\2\2TW\3\2\2\2UW\7\17\2\2VQ\3\2\2\2VU\3\2\2\2WY\3\2\2\2XZ\7\f\2\2YX"+
