...
import thirdLab.ThirdLabLexer
import thirdLab.ThirdLabParser
...
class ThirdLabTests {
    ...
    private fun testThirdLab(input: String, expected: String) {
        val parser = ThirdLabParser(ThirdLabLexer(input))
